...
* referenced by Titanium.Filesystem.getApplicationDataDirectory.      
...
*		var document = Titanium.Filesystem.getFile(Titanium.Filesystem.getApplicationDataDirectory(),'custom.txt');
*		
*		if(document.exists()) {
...
*		var document = Titanium.Filesystem.getFileStream(Titanium.Filesystem.getApplicationDataDirectory(),'custom.txt');
*		document.open(Titanium.Filesystem.MODE_WRITE);
...
*			Titanium.UI.getCurrentWindow().setMenu(menu);
*
...
* All windows in TideSDK are Titanium.UI.UserWindow objects.      
...
*
*		Titanium.UI.currentWindow.hide(); //window hidden
*		setTimeout(function() {
*			Titanium.UI.currentWindow.show(); //window shown
*		}, 3000);
*		
* 
...
* @param {Titanium.UI.Menu|null} menu The Menu object to use as the context menu or null to unset the menu.
* @return {String}
* @member Titanium.UI.UserWindow
*/
setContextMenu: function(menu){},
...
* @param {Titanium.UI.Menu|null} menu The Menu object to use as the menu or null to unset the menu.
* @return {String}
* @member Titanium.UI.UserWindow
*/
setMenu: function(menu){},
